...
public class StudentMethods {
    ...
    {
        System.out.print("| ");
        printPaddedString(nameContent, nameWidth);
        System.out.print(" | ");
        printPaddedString(surnameContent, surnameWidth);
        System.out.print(" | ");
        printPaddedString(idContent, idWidth);
        System.out.print(" | ");
        printPaddedString(quizContent, quizWidth);
        System.out.println(" |");
    ...
    {
        System.out.print("+");
        printDashLine(nameWidth + 2);
        System.out.print("+");
        printDashLine(surnameWidth + 2);
        System.out.print("+");
        printDashLine(idWidth + 2);
        System.out.print("+");
        printDashLine(quizWidth + 2);
        System.out.println("+");
    ...
    private static void printPaddedString(String content, int width) {
        int spacesToAdd = width - content.length();
